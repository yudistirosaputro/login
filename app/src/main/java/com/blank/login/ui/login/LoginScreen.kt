...
import com.blank.login.ui.component.RoundedButton
import com.blank.login.ui.theme.Grey80
...
fun LoginScreen(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.welcome_back_glad_to_see_you_again),
            fontSize = 16.sp,
            color = Color.Gray
        )
        ...
        Text(
            text = stringResource(R.string.don_t_have_an_account_sign_up_here),
